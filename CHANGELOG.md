...
## 0.1.10 Release
- Modify plugin icons and readme files, fix bugs in reading third-party libraries
## 0.1.9 Release
- Optimize Chinese and English display
## 0.1.8 Release
- Add a prompt to install both Gitlens plugins at the same time and deactivate the functionality of this plugin
- Add Chinese and English navigation and improve Chinese English translation in readme file and some menu
## 0.1.7 Release
- modify repository and some relevent url address in package.json.
- perfect show single file history function.
- add English and Chinese translations to the readme file.

## 0.1.6 Release
- fix some bugs.
- add show single file history.
...
## 0.1.4 Release
- add depends for server system

## 0.1.3 Release
- fix install extension with error message

## 0.1.2 Release
- add support for both Chinese and English
- remove welcome page for install
- fix some bugs


## 0.1.1 Release
- add keywords
- add commits relevant view
- add show commits per author



## 0.1.0 Release
- copy from https://github.com/gitkraken/vscode-gitlens/  version:11.7.0
- rename publisher and set version 0.1.0
- change eamido.gitlens to KylinIDETeam.gitlens
...
- Adds a new and improved _Git Commands_ (`gitlens.gitCommands`) experience
  ...
  - Adds a confirmation indicator / toggle button to the quick pick menu toolbar
    - Indicates whether the specified Git command will have a confirmation step &mash; some commands require confirmation and can't be toggledd
