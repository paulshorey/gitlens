...
> GitLens **supercharges** the Git capabilities built into IDE. It helps you to **visualize code authorship** at a glance via Git blame annotations and code lens, **seamlessly navigate and explore** Git repositories, **gain valuable insights** via powerful comparison commands, and so much more.
...
# Gitlens lower version for friendly license

- Fork of eamodio.gitlens, modified on the lower version for friendly license.
- Modified based on the version 11.7.0 of gitlens
- Gitlens is an opensource extension for VSCode or Kylin-IDE,Supercharge the Git capabilities built into IDE — Visualize code authorship at a glance via Git blame annotations and code lens, seamlessly navigate and explore Git repositories, gain valuable insights via powerful comparison commands, and so much more

[GitLens](https://gitlens.amod.io 'Learn more about GitLens') is an [open-source](https://gitee.com/openkylin/ide-gitlens 'Open GitLens on Gitee') extension for VScode or Kylin-IDE.
...
GitLens adds many side bar views to provide additional rich functionality. The default layout (location) of these views can be quickly customized via the _GitLens: Set Views Layout_ (`gitlens.setViewsLayout`) command from the _Command Palette_.
...
<p style="display:flex;justify-content:space-around">
  <img src="https://github.com/xiayuqi0509/forgitlensimage/tree/main/images/docs/views-layout-scm.png" alt="Views Layout: Source Control" />
  <img src="https://github.com/xiayuqi0509/forgitlensimage/tree/main/images/docs/views-layout-gitlens.png" alt="Views Layout: GitLens" />
</p>
...
| `gitlens.currentLine.format`               | Specifies the format of the current line blame annotation.Date formatting is controlled by the `gitlens.currentLine.dateFormat` setting                                             |
...
| `gitlens.codeLens.symbolScopes`             | Specifies a set of document symbols where Git code lens will or will not be shown in the document. Prefix with `!` to avoid providing a Git code lens for the symbol.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `gitlens.statusBar.format`               | Specifies the format of the blame information in the status bar.Date formatting is controlled by the `gitlens.statusBar.dateFormat` setting                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `gitlens.statusBar.tooltipFormat`        | Specifies the format (in markdown) of hover shown over the blame information in the status bar.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `gitlens.hovers.detailsMarkdownFormat` | Specifies the format (in markdown) of the _commit details_ hover.                              |
...
| `gitlens.views.formats.commits.label`       | Specifies the format of commits in the views.
| `gitlens.views.formats.commits.description` | Specifies the description format of commits in the views.
| `gitlens.views.formats.files.label`         | Specifies the format of a file in the views.
| `gitlens.views.formats.files.description`   | Specifies the description format of a file in the views.
| `gitlens.views.formats.stashes.label`       | Specifies the format of stashes in the views.
| `gitlens.views.formats.stashes.description` | Specifies the description format of stashes in the views.
...
| `gitlens.blame.format`              | Specifies the format of the gutter blame annotations.Date formatting is controlled by the `gitlens.blame.dateFormat` setting                     |
...
GitLens defines a set of themable colors which can be provided by Vscode/Kylin-IDE themes or directly by the user using `workbench.colorCustomizations`.
